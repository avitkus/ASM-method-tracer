...
public class Premain {
	...
	private static final String[] callerFilters = {"edu/unc/cs/asm_test/.*", "mp/.*", "grail/.*", "main/.*"};
	private static final String[] calledFilters = {"edu/unc/cs/asm_test/.*", "mp/.*", "grail/.*", "main/.*"};
